...
class PostEditScreenF extends StatefulWidget {
  final List<File> selectedImages;
  final LatLng location;

  PostEditScreenF({required this.selectedImages, required this.location});

  @override
  _PostEditScreenFState createState() => _PostEditScreenFState();
}

class _PostEditScreenFState extends State<PostEditScreenF> {
              ...
              ElevatedButton(
                onPressed: _selectedLocation != null
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => PostEditScreenF(
              ...
              InkWell(
                onTap: () async {
                  List<File> newImages = await Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => ImagePickerScreen(status: 'found'),
                    ),
                  );
